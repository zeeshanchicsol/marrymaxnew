...
public class mButton2 extends AppCompatButton {
    public static final String ANDROID_SCHEMA = "http://schemas.android.com/apk/res/android";

    public mButton2(Context context) {
        super(context);

        applyCustomFont(context);
    }

    public mButton2(Context context, AttributeSet attrs) {
        super(context, attrs);

        applyCustomFont(context, attrs);
    }

    public mButton2(Context context, AttributeSet attrs, int defStyle) {
