...
*/
   ...
   /*     if (searchKey != null) {
    ...
    private void initilize() {
        ...
        tvMatchesCountSub = (TextView) findViewById(R.id.TextViewMMMatchesCountSubscribeNow);

        tvTitle = (TextView) findViewById(R.id.TextViewMMMatchesTitleSubscribeNow);
        tvTitle.setText("Members Are Looking For You");
        ...
        btMyMatchesSubscribeClick = (AppCompatButton) findViewById(R.id.ButtonMyMatchesSubscribeClick);
        ...
        LinearLayoutMMMatchesNotFound = (LinearLayout) findViewById(R.id.LinearLayoutMMMatchesNotFoundSubscribeNow);
    ...
    private void setListenders() {
        ...
        btMyMatchesSubscribeClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WhoIsLookingForMeResultsActivity.this, ActivityLogin.class);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            tvMatchesCountSub.setText(NumberFormat.getNumberInstance(Locale.getDefault()).format(id) + "");
