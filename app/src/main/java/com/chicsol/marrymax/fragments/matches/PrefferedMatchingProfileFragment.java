                        ...
                        try {
                            ...
                            if (jsonArray.length() > 1) {
                                ...
                                if (membersDataList.size() > 0) {
                                    ...
                                    lastPage = 1;
                                    Log.e("total pages", memberTotalPages.get_total_member_count() + "====" + totalPages);
...
// Adding request to request queue
    ...
    private void getRawData() {
        ...
        Log.e("getRawData started", Urls.getRawData + SharedPreferenceManager.getUserObject(context).get_path() + "/pm");
        JsonArrayRequest req = new JsonArrayRequest(Urls.getRawData + SharedPreferenceManager.getUserObject(context).get_path() + "/pm",
