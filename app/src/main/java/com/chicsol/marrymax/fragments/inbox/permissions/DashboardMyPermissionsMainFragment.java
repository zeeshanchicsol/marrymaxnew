...
public class DashboardMyPermissionsMainFragment extends Fragment implements DashboarMainActivityWithBottomNav.BottomNavSelected {
    ...
    private void setupViewPager(ViewPager viewPager) {
       ...
       Bundle bundle = new Bundle();
        ...
        bundle2.putString("type", "pg");



        Fragment receieved = new DashboardPermissionsFragment();
     receieved.setArguments(bundle);


        Fragment sent = new DashboardPermissionsFragment();
        sent.setArguments(bundle2);

        adapter.addFragment(receieved, " Permissions Received ");
    adapter.addFragment(sent, " Permissions Granted ");
