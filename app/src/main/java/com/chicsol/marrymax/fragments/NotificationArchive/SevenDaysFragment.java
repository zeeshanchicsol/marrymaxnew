...
public class SevenDaysFragment extends Fragment implements RecyclerViewAdapterNotificationArchive.OnItemClickListener {
    ...
    Context context;
private  String Tag="SevenDaysFragment";
    @Override
    ...
    private void initilize(View view) {
        ...
        recyclerAdapter.setOnItemClickListener(SevenDaysFragment.this);
