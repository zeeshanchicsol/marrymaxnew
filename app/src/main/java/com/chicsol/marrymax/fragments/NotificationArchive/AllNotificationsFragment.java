...
public class AllNotificationsFragment extends Fragment implements RecyclerViewAdapterNotificationArchive.OnItemClickListener {
    ...
    private void initilize(View view) {
        ...
        recyclerAdapter.setOnItemClickListener(AllNotificationsFragment.this);
