...
public class dialogPhoneDetails extends DialogFragment {
    ...
    public static dialogPhoneDetails newInstance(String params, String alias) {
        /*       Members member, String userpath, boolean replyCheck, Members member2*/
        dialogPhoneDetails frag = new dialogPhoneDetails();
...
*/
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     /*   Log.e("name Fragment", name);
        ...
        Type type = new TypeToken<mContacts>() {
        }.getType();
        member = (mContacts) gson.fromJson(params, type);

    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.dialog_phone_details, container, false);
...
//Landline checks
        if (!member.getLandline_mobile().equals("")) {
            landPhone.setText("" + member.getLandline_mobile());
        ...
        mTextView contactAge = (mTextView) rootView.findViewById(R.id.TextViewContactDialogAge);
     ...
     //   contactName.setText("" + member.getPersonal_name());
        ...
        contactAge.setText("" + member.getMin_age());

        contactCalltime.setText("" + member.getOther_info());
    ...
    /*    String aliass= SharedPreferenceManager.getUserObject(getContext()).getAlias();
        ...
        mOkButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(final View v) {
                ...
                dialogPhoneDetails.this.getDialog().cancel();
