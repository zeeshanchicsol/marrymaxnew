...
public class RecyclerViewAdapterFeedbackQuestions extends RecyclerView.Adapter<RecyclerViewAdapterFeedbackQuestions.MMViewHolder> implements View.OnClickListener {
...
/*
    ...
    public void addAll(List<WebArd> lst) {
        items.clear();
        items.addAll(lst);
        notifyDataSetChanged();
