...
public class DocsListAdapter extends ArrayAdapter<mDoc> {
    public OnUpdateListener onUpdateListener;
    Activity context;
    int layoutResourceId;
    List<mDoc> data = new ArrayList<>();

    public DocsListAdapter(Activity context, int layoutResourceId, List<mDoc> data, OnUpdateListener onUpdateListener) {
